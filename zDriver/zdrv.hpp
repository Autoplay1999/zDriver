...
#define ZDRV_IOCTL_PROTECT_MEMORY			CTL_CODE(FILE_DEVICE_UNKNOWN, 0x1106, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define ZDRV_IOCTL_GET_PROCESS_PEB			CTL_CODE(FILE_DEVICE_UNKNOWN, 0x1107, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
#define ZDRV_IOCTL_GET_PROCESS_BASE			CTL_CODE(FILE_DEVICE_UNKNOWN, 0x1108, METHOD_BUFFERED, FILE_SPECIAL_ACCESS)
...
struct INPUT_PROTECT_MEMORY_IOCTL_CALL : INPUT_MEMORY_IOCTL_CALL {
...
struct OUTPUT_PROTECT_MEMORY_IOCTL_CALL : OUTPUT_BASE_IOCTL_CALL {
